...
To do!! 
1. Change interface to GetValue for field values
2. Switch lot and non lot receipt to simplier MHS850 transaction
3. Decomission this script and use version in GH repo (and other version in Benco folder (latest V1 as of 12/31/25))
4. Limit outputs to reduce data sent back between calls
5. Convert log to H5 standard
6. Review ErrorConsole.log file in Benco folder, to detail how i want pop ups to show when things fail
7. Include TTYP in Message line = 20
8. Check if using CSS and HTML objects in conditionals is best practice per guide
