...
@Component({
	template: `
		<div class="lm-padding-lg">
			<p>
				User context will be loaded only once and shared among all widgets using
				the specified shared module
			</p>
			<div class="lm-margin-md-t">
				<button soho-button="primary" (click)="getAndSetUserContext()">
					Get user info
				</button>
			</div>
			<div class="field">
