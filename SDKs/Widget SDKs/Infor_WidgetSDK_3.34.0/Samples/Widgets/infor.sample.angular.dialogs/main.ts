...
@Component({
	template: ` <div #dialogWidgetView class="container">
...
export class DialogsComponent {
	@ViewChild("dialogWidgetView", { read: ViewContainerRef, static: true })
