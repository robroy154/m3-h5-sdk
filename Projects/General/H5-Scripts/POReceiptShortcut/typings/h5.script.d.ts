/*
 * Local copy of the SDK baseline typings, taken verbatim from
 *   SDKs/M3 H5 Scripting/Templates/H5ScriptsProjectTemplate/typings/h5.script.d.ts
 * with exactly one change: `declare module infor.companyon` became
 * `declare namespace infor.companyon`, because TypeScript 5+ rejects the
 * deprecated `module` keyword for a dotted name. The SDK tree itself is
 * vendored and never modified, which is why this is a copy rather than a
 * reference.
 */
...
declare namespace infor.companyon {
    class client {
