...
/*─────────────────────────────────────────────────────────────────────────────
  ...
  • Uses confirmed purchase price (CPPR) when populated, falls back to PUPR
─────────────────────────────────────────────────────────────────────────────*/
...
var POReceiptShortcutV6 = /** @class */ (function () {
    function class_1(args) {
        ...
        this.log.Info('POReceiptShortcutV6 initialized successfully');
    }
    class_1.Init = function (args) {
        // Entry point: Initialize script (supports fallbacks for < 2.0)
        try {
            var self_1 = new POReceiptShortcutV6(args);
            ...
            if (args === null || args === void 0 ? void 0 : args.log) {
                args.log.Error("POReceiptShortcutV6 initialization failed: ".concat(error.message || error));
            }
    ...
    class_1.prototype.extractErrorMessage = function (error, operation) {
        ...
        var technicalDetails = this.getTechnicalDetails(error);
        return errorMsg + technicalDetails;
    };
    class_1.prototype.getPrimaryErrorMessage = function (error, defaultMsg) {
    ...
    class_1.prototype.getTechnicalDetails = function (error) {
    ...
    class_1.prototype.hasErrorDetails = function (errorCode, errorMessage, errorField, program) {
        return errorCode || errorMessage || errorField || program;
    };
    class_1.prototype.formatErrorCode = function (errorCode, errorMessage) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        // Step 2: Fetch PO line, WMS, item, and remaining-qty data in parallel
                        return [4 /*yield*/, this.fetchInitialData()];
                    case 3:
                        // Step 2: Fetch PO line, WMS, item, and remaining-qty data in parallel
                        _b.sent();
                        // Step 3: Resolve customer order if PO is CO-linked (needs RORC from step 2)
                        return [4 /*yield*/, this.resolveCustomerOrder()];
                    case 4:
                        // Step 3: Resolve customer order if PO is CO-linked (needs RORC from step 2)
                        _b.sent();
                        return [4 /*yield*/, this.advance('Fetch data')];
                    case 5:
                        _b.sent();
                    ...
                    case 7:
                        _b.sent();
                        if (!(this.INDI === '2')) return [3 /*break*/, 20];
                    ...
                    case 18:
                        this.receiptSummary = {
                            type: 'serial',
                            banos: serialEntries.map(function (e) { return e.derivedSerial; }),
                            whsl: this.WHSL,
                        };
                        return [4 /*yield*/, this.advance('Finalizing message')];
                    case 19:
                        _b.sent();
                        return [3 /*break*/, 27];
                    case 20:
                        if (!(this.INDI === '3')) return [3 /*break*/, 24];
                    ...
                    case 23:
                        ...
                        return [3 /*break*/, 27];
                    case 24: return [4 /*yield*/, this.promptConfirm()];
                    case 25:
                    ...
                    case 26:
                        ...
                        _b.label = 27;
                    case 27: return [4 /*yield*/, this.advance('Process')];
                    case 28:
                        _b.sent();
                        this.progressDone();
    ...
    class_1.prototype.showSuccessDialog = function () {
        var _a, _b;
        var s = this.receiptSummary;
        var lines;
        if ((s === null || s === void 0 ? void 0 : s.type) === 'serial') {
            var count = ((_a = s.banos) === null || _a === void 0 ? void 0 : _a.length) || 0;
            lines = __spreadArray([
                "".concat(count, " serial").concat(count === 1 ? '' : 's', " received to ").concat(s.whsl || '(no location)')
            ], __read((((_b = s.banos) === null || _b === void 0 ? void 0 : _b.length) > 0 ? ["Serials: ".concat(s.banos.join(', '))] : [])), false);
        }
        else if ((s === null || s === void 0 ? void 0 : s.type) === 'lot') {
            var qty = this.num(s.qty);
            lines = __spreadArray([
                "".concat(qty, " unit").concat(qty === 1 ? '' : 's', " received to ").concat(s.whsl || '(no location)'),
                "Lot: ".concat(s.bano)
            ], __read((s.expi ? ["Expiry: ".concat(s.expi)] : [])), false);
        }
        else {
            var qty = this.num(s === null || s === void 0 ? void 0 : s.qty);
            lines = [
                "".concat(qty, " unit").concat(qty === 1 ? '' : 's', " received to ").concat((s === null || s === void 0 ? void 0 : s.whsl) || '(no location)'),
            ];
        }
        this.alert('Success', lines.join('\n'), true); // Refresh screen on success
    };
    class_1.prototype.showFre3Prompt = function (banos) {
        var banoList = (banos || []).join(', ');
        var message = "Additional serial entry required for item ".concat(this.ITNO, "\n(SN: ").concat(banoList, ")\nProceed to MMS240 to finish receiving.");
    ...
    class_1.prototype.fetchInitialData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var poLineRequest, whsRequest, itemRequest, remRequest, _a, pol, whs, itm, rem, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        poLineRequest = new MIRequest();
                        poLineRequest.program = 'PPS200MI';
                        poLineRequest.transaction = 'GetLine';
                        poLineRequest.record = { PUNO: this.PUNO, PNLI: this.PNLI, PNLS: this.PNLS };
                        poLineRequest.maxReturnedRecords = 1;
                        poLineRequest.outputFields = ['PUPR', 'CPPR', 'RORC', 'RORN', 'ITDS', 'GETY', 'PUUN', 'FACI', 'RGDT'];
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all([
                                this.mi.executeRequest(poLineRequest),
                                this.mi.executeRequest(whsRequest),
                                this.mi.executeRequest(itemRequest),
                                this.mi.executeRequest(remRequest),
                            ])];
                    case 2:
                        _a = __read.apply(void 0, [_b.sent(), 4]), pol = _a[0], whs = _a[1], itm = _a[2], rem = _a[3];
                        // PO line
                        if (!(pol === null || pol === void 0 ? void 0 : pol.item)) {
                            throw new Error(this.extractErrorMessage(pol, 'PO line retrieval'));
                        }
                        Object.assign(this, {
                            PUPR: pol.item.PUPR,
                            CPPR: pol.item.CPPR,
                        ...
                        // Use confirmed purchase price when populated; fall back to original purchase price
                        this.PUPR = (this.CPPR && this.CPPR.trim() !== '') ? this.CPPR : this.PUPR;
                        // WMS check — record presence means warehouse is WMS-managed
                        this.isWmsWhs = !!(whs === null || whs === void 0 ? void 0 : whs.item);
                        // Item master
                        if (!(itm === null || itm === void 0 ? void 0 : itm.item)) {
                            throw new Error(this.extractErrorMessage(itm, 'Item details retrieval'));
                        }
                        Object.assign(this, {
                        ...
                        if (!(rem === null || rem === void 0 ? void 0 : rem.item)) {
                            throw new Error(this.extractErrorMessage(rem, 'Remaining quantity retrieval'));
                        }
                        this.RMQA = rem.item.RSTQ;
                        return [3 /*break*/, 4];
                    case 3:
                        error_4 = _b.sent();
                        this.log.Error("fetchInitialData failed: ".concat(error_4.message || error_4));
                        throw error_4;
                    case 4: return [2 /*return*/];
                }
            });
    ...
    class_1.prototype.resolveCustomerOrder = function () {
        return __awaiter(this, void 0, void 0, function () {
            var customerRequest, c, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // Only needed when PO is linked to a customer order (RORC=3)
                        ...
                        customerRequest.record = { ORNO: this.RORN };
                    ...
                    case 2:
                        ...
                        if (!(c === null || c === void 0 ? void 0 : c.item)) {
                            throw new Error(this.extractErrorMessage(c, 'Customer order details retrieval'));
                        }
                        this.CUNO = c.item.CUNO; // Customer Number for equipment records
                        return [3 /*break*/, 4];
                    case 3:
                        error_5 = _a.sent();
                        this.log.Error("resolveCustomerOrder failed: ".concat(error_5.message || error_5));
                        throw error_5;
                    case 4: return [2 /*return*/];
                }
            });
    ...
    class_1.prototype.promptSerials = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var removeErrorDiv = function (errorDiv) {
                errorDiv.remove();
            };
            // Helper to fade out error message
            var fadeOutError = function (errorDiv) {
                errorDiv.fadeOut(function () { return removeErrorDiv(errorDiv); });
            };
            ...
            dialogContent.showValidationError = function (message) {
                ...
                setTimeout(function () { return fadeOutError(errorDiv); }, 5000);
            };
            ...
            var fadeOutAndRemove = function (element) {
                element.fadeOut(300, function () {
                    $(this).remove();
                });
            };
            // Helper function to reset button style
            var resetGenerateButtonStyle = function (btn, originalText) {
            ...
            dialogContent
                ...
                setTimeout(function () { return fadeOutAndRemove(successMsg); }, 3000);
                // Visual feedback on button
                var btn = $(this);
                var originalText = btn.text();
                btn.text('✓ Done!').css('background', '#28a745');
                setTimeout(function () { return resetGenerateButtonStyle(btn, originalText); }, 1500);
    ...
    class_1.prototype.promptLot = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            dialogContent.showValidationError = function (message) {
                ...
                // Auto-remove after 5 seconds
                var removeErrorDiv = function () { return errorDiv.remove(); };
                setTimeout(function () { return errorDiv.fadeOut(removeErrorDiv); }, 5000);
            };
            // Bind the validation error method to the correct context
            var showValidationError = dialogContent.showValidationError;
            // Add copy functionality for PO number
            ...
            var validateLotInputs = function () {
                ...
                var expi = expirationDateRequired
                    ? dialogContent.find("#".concat(expirationDateId)).val() || null
                    : null;
                var errors = [];
                _this.validateLotNumber(lot, $lot, errors);
                _this.validateExpirationDate(expi, errors);
                if (errors.length) {
            ...
            var handleLotFieldKeyDown = function (e) {
                var _a;
                if (e.key !== 'Enter')
                    return;
                e.preventDefault();
                ...
                _this.handleLotSaveAction(dialogContent, lotNumberId, expirationDateRequired, validateLotInputs);
            };
            // Add Enter key handling for lot inputs
            dialogContent
                .find("#".concat(lotNumberId, ", #").concat(expirationDateId))
                .on("keydown".concat(_this.eventNamespace), handleLotFieldKeyDown);
            var dialogButtons = [
                {
                    text: 'Save',
                    isDefault: true,
    ...
    class_1.prototype.checkLot = function (lot) {
        return __awaiter(this, void 0, void 0, function () {
            var rq, response, items, exists, error;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        exists = items.some(function (r) { return (r === null || r === void 0 ? void 0 : r.ITNO) === _this.ITNO && (r === null || r === void 0 ? void 0 : r.BANO) === lot; });
                        if (exists) {
                            error = "Lot ".concat(lot, " for item ").concat(this.ITNO, " already exists.");
                            this.log.Warning("checkLot: ".concat(error));
                            throw new Error(error);
                        }
                        return [2 /*return*/];
                }
    ...
    class_1.prototype.validateLotNumber = function (lot, $lot, errors) {
        if (!lot) {
    ...
    class_1.prototype.validateExpirationDate = function (expi, errors) {
        if (this.EXPD === '1') {
            if (!expi) {
    ...
    class_1.prototype.handleLotSaveAction = function (dialogContent, lotNumberId, expirationDateRequired, validateLotInputs) {
                ...
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        rq.record = {
                            ...
                            PUPR: this.PUPR, // Purchase Price (CPPR when populated, else PUPR)
    ...
    class_1.prototype.process = function (lines) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, resolvedPackNumber, e_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 5, , 6]);
                        _a = this;
                        return [4 /*yield*/, this._createWarehouseHeader()];
                    case 1:
                        _a.MSGN = _b.sent();
                        return [4 /*yield*/, this._createWarehousePackage()];
                    case 2:
                        resolvedPackNumber = _b.sent();
                        return [4 /*yield*/, this._addWarehouseLines(lines, resolvedPackNumber)];
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, this._processAndValidateTransaction(resolvedPackNumber)];
                    case 4:
                        _b.sent();
                    ...
                    case 5:
                        e_3 = _b.sent();
                        this.log.Error("process: Receipt processing failed: ".concat(e_3.message || e_3));
                        throw e_3;
    ...
    class_1.prototype._createWarehouseHeader = function () {
        return __awaiter(this, void 0, void 0, function () {
            var head, h;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        h = _b.sent();
                        if (!((_a = h === null || h === void 0 ? void 0 : h.item) === null || _a === void 0 ? void 0 : _a.MSGN)) {
                            throw new Error(this.extractErrorMessage(h, 'Warehouse transaction header creation'));
                        }
                        return [2 /*return*/, h.item.MSGN];
                }
            });
        });
    };
    class_1.prototype._createWarehousePackage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var packNumber, pack, packResult;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        if ((packResult === null || packResult === void 0 ? void 0 : packResult.errorCode) ||
                            ...
                            !((_a = packResult === null || packResult === void 0 ? void 0 : packResult.item) === null || _a === void 0 ? void 0 : _a.PACN)) {
                            throw new Error(this.extractErrorMessage(packResult, 'Warehouse package creation'));
                        }
                        return [2 /*return*/, packResult.item.PACN || packNumber];
                }
            });
        });
    };
    class_1.prototype._addWarehouseLines = function (lines, resolvedPackNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var lines_1, lines_1_1, rec, line, lineResult, lineId, e_4_1;
            var e_4, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _b.label = 1;
                    case 1:
                        if (!!lines_1_1.done) return [3 /*break*/, 4];
                        rec = lines_1_1.value;
                        line = new MIRequest();
                    ...
                    case 6:
                        ...
                        return [7 /*endfinally*/];
                    case 7:
                        if (!(lines.length > 1)) return [3 /*break*/, 9];
    ...
    class_1.prototype._addOptionalLineFields = function (line, rec) {
    ...
    class_1.prototype._processAndValidateTransaction = function (resolvedPackNumber) {
        return __awaiter(this, void 0, void 0, function () {
            var pr, prc, statusResult, transactionStatus;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pr = new MIRequest();
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this._getTransactionStatus()];
                    case 3:
                        statusResult = _a.sent();
                        transactionStatus = statusResult.item.STAT;
                        if (!(transactionStatus !== '90')) return [3 /*break*/, 5];
                        return [4 /*yield*/, this._handleTransactionFailure(transactionStatus, resolvedPackNumber, statusResult)];
                    case 4:
                        _a.sent();
                        _a.label = 5;
    ...
    class_1.prototype._getTransactionStatus = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    class_1.prototype._handleTransactionFailure = function (transactionStatus, resolvedPackNumber, statusResult) {
        return __awaiter(this, void 0, void 0, function () {
            var lineFailureDetail, _a, errorMessage, statusDesc;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!['25', '30', '35', '40', '45'].includes(transactionStatus)) return [3 /*break*/, 2];
                    ...
                    case 3:
                        ...
                        errorMessage = this._buildStatusErrorMessage(transactionStatus, resolvedPackNumber, lineFailureDetail, statusResult);
                        ...
                        if (!(((_b = this.createdEquipment) === null || _b === void 0 ? void 0 : _b.length) > 0)) return [3 /*break*/, 5];
    ...
    class_1.prototype._buildStatusErrorMessage = function (transactionStatus, resolvedPackNumber, lineFailureDetail, statusResult) {
        var statusDesc = this.getTransactionStatusDescription(transactionStatus);
        var troubleshootingInfo = this._getTroubleshootingInfo(transactionStatus, resolvedPackNumber, lineFailureDetail);
        var statusLines = [];
        var trimmedTroubleshooting = troubleshootingInfo === null || troubleshootingInfo === void 0 ? void 0 : troubleshootingInfo.trim();
    ...
    class_1.prototype.alert = function (title, message, shouldRefresh) {
        ...
        var dialogContent = $('<div style="max-width: 500px; word-wrap: break-word;"><label class="inforLabel noColon"></label></div>');
        var label = dialogContent.find('label');
...
//# sourceMappingURL=POReceiptShortcutV6.js.map