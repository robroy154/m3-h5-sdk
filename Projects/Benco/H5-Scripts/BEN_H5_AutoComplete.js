...
var BEN_H5_AutoComplete = /** @class */ (function () {
    function class_1(scriptArgs) {
        this.translations = {
            GB: {
                ...
                fieldNameError: "BEN_H5_AutoComplete: Field {} not found. Check script arguments or if you're in the right screen.",
                fieldNameInvalid: "Unable to find field. You must enter the correct field name with a position id.",
    ...
    class_1.prototype.run = function () {
        ...
        if (numberOfArguments < 4) {
            return this.showMessage(""
                ...
                .concat(String(numberOfArguments)), DialogType.Error);
        }
        // Extract script arguments
        var searchField = scriptArguments[0], program = scriptArguments[1], transaction = scriptArguments[2], searchCriteria = scriptArguments.slice(3);
        this.searchfieldOptions = {
            Element: searchField,
            Height: "400",
        };
        ...
        this.$searchField = this.initializeSearchFieldComponent(this.searchfieldOptions);
        var widget = this.setupWidget(this.$searchField, this.transactionOptions, this.searchfieldOptions.Height);
        this.addEvents(searchField, widget);
    };
    class_1.prototype.initializeSearchFieldComponent = function (searchFieldOptions) {
        ...
        if ($searchField.length === 0) {
            ...
            if (!$searchField) {
                ...
                this.log.Info(this.translate("searchfieldExists", [searchFieldOptions.Element]));
            }
        }
    ...
    class_1.prototype.addEvents = function (searchField, widget) {
        var _this = this;
        var unsubscribeRequesting = this.controller.Requesting.On(function (args) {
            _this.log.Debug("Event: Requesting, Command type: "
            ...
            if (args.commandType === "KEY" && args.commandValue === "ENTER") {
                ...
                if (isFocused && isOpen) {
                    _this.log.Debug("Canceling ENTER request --> widget menu is open and ".concat(searchField, " has focus"));
                    args.cancel = true;
                }
            }
        });
        var unsubscribeRequested = this.controller.Requested.On(function (args) {
            _this.log.Debug("Event: Requested, Command type: "
                .concat(args.commandType, ", Command value: ")
            ...
            if (args.commandType == "PAGE" && args.commandValue == "DOWN") {
                ...
                setTimeout(function () {
                    _this.$searchField = _this.initializeSearchFieldComponent(_this.searchfieldOptions);
                    widget = _this.setupWidget(_this.$searchField, _this.transactionOptions, _this.searchfieldOptions.Height);
                }, 5);
            }
        });
    };
    class_1.prototype.setupWidget = function (element, transactionOptions, widgetHeight) {
        element.keydown(function (event) {
            ...
            if (isOpen) {
                if (event.which === 37 ||
                    event.which === 39 ||
                    (event.which === 38 &&
                        ((_a = widget.menu.active) === null || _a === void 0 ? void 0 : _a.index()) === 0)) {
    ...
    class_1.prototype.defineSearchOptions = function (element, transactionOptions) {
        var _this = this;
        return {
            autoFocus: false,
            delay: 300,
            ...
            source: function (search, response) {
                ...
                if (searchTerm in _this.cacheSelectedItems) {
                    _this.log.Debug("searchTerm : ".concat(searchTerm, " exists in selected items cache return previous result"));
                    return response(_this.cache[_this.cacheSelectedItems[searchTerm]]);
                }
                if (searchTerm in _this.cache) {
                    _this.log.Debug("searchTerm : ".concat(searchTerm, " exists in cache returning cached result"));
                    return response(_this.cache[searchTerm]);
                }
                _this.currentSearchTerm = searchTerm;
                var request = _this.createRequest(searchTerm, transactionOptions.program, transactionOptions.transaction, transactionOptions.SQRY);
                return MIService.Current.executeRequestV2(request)
                    .then(function (miResponse) {
                    if (miResponse.hasError()) {
                        var message = miResponse.errorMessage || _this.translate("unknownError");
            ...
            select: function (_event, ui) {
                var _a = ui.item, _label = _a._label, value = _a.value;
                _this.cacheSelectedItems[value] = _this.currentSearchTerm;
                var elementId = element.attr("id");
                if (elementId.includes("header-filter") ||
    ...
    class_1.prototype.getFontSizeFromInput = function () {
        return this.searchfieldOptions
            ? $("input#".concat(this.searchfieldOptions.Element, " ")).css("font-size") || "14px"
            : "14px";
    };
    class_1.prototype.extendWidget = function (widget) {
        var _this = this;
        ...
        widget._renderItem = function (ul, item) {
            ...
            var listItem = '<p class="listview-heading no-margin" '
        ...
        widgetMenu._addClass = function (u, v, C) {
            ...
            if (C === null || C === void 0 ? void 0 : C.includes(oldActiveClass)) {
                ...
                u = (_a = this.active) !== null && _a !== void 0 ? _a : this.element.children().first();
            }
    ...
    class_1.prototype.createRequest = function (searchTerm, program, transaction, searchCriteria) {
            ...
            switch (transaction) {
                ...
                case "LstFCHACC00-IES":
                    if (searchCriteria.length === 3) {
                        var _a = __read(searchCriteria, 3), first = _a[0], second = _a[1], third = _a[2];
    ...
    class_1.prototype.getDataGridInputFieldById = function (id) {
        var _a, _b, _c;
        ...
        if (column) {
            this.log.Debug("Column found! Using positionField.name: ".concat(column.positionField.name));
            var fieldName = column.positionField.name;
            var $input = $((_c = (_b = (_a = grid.getPosFieldElement(fieldName)) === null || _a === void 0 ? void 0 : _a.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector("input")) !== null && _c !== void 0 ? _c : grid.getPosFieldElement(fieldName));
            if ($input.length === 0) {
                return null;
            }
            return $input;
    ...
    class_1.prototype.transformSearchCriteria = function (searchCriteria) {
    ...
    class_1.prototype.generateSearchQuery = function (query, searchCriteria) {
    ...
    class_1.prototype.parseResponse = function (response) {
     ...
     * [{value: "a", "label": "a --- b --- c"}]
     */
    class_1.prototype.transformResponse = function (response) {
    ...
    class_1.prototype.filterSearch = function (searchTerm, result) {
    ...
    class_1.prototype.sortItems = function (a, b) {
        if (a.value > b.value) {
            return 1;
        }
        if (a.value < b.value) {
    ...
    class_1.prototype.isNumeric = function (num) {
        return !isNaN(Number(num));
    };
    class_1.prototype.showMessage = function (message, dialogType, header) {
    ...
    class_1.prototype.translate = function (translation, stringValues) {
        ...
        if (stringValues === null || stringValues === void 0 ? void 0 : stringValues.length) {
    ...
    class_1.prototype.parseArguments = function (scriptArguments) {
