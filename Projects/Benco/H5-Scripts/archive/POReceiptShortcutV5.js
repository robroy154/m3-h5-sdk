...
/*──────────────────────────────────────────────────────────────────────────*/
var POReceiptShortcutV5 = /** @class */ (function () {
    ...
    class_1.Init = function (args) {
        ...
        try {
            var self_1 = new POReceiptShortcutV5(args);
            ...
            if (args === null || args === void 0 ? void 0 : args.log) {
                args.log.Error("POReceiptShortcutV5 initialization failed: ".concat(error.message || error));
            }
    ...
    class_1.prototype.lookups = function () {
        return __awaiter(this, void 0, void 0, function () {
            var whsRequest, itemRequest, remRequest, _a, whs, itm, rem, errorMessage, errorMessage, customerRequest, c, errorMessage, error_5;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 3]), whs = _a[0], itm = _a[1], rem = _a[2];
                        ...
                        if (!(this.RORC === '3' && this.RORN)) return [3 /*break*/, 3];
...
//# sourceMappingURL=POReceiptShortcutV5.js.map